...
def is_owner(user, group):
    ...
    return GroupMembership.objects.filter(group=group, profile=user.profile, role='owner').exists()


def handle_database_error(detail_message):
    """Обработчик ошибок базы данных"""
    return Response({'detail': detail_message}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class GroupViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        if not groups_data:
            try:
                ...
                cache.set(cache_key, groups_data, timeout=300)  # Кэшируем на 5 минут
            except DatabaseError:
                return handle_database_error('Ошибка базы данных при получении списка групп')
    ...
    def create(self, request):
        ...
        if serializer.is_valid():
            try:
                ...
                return Response({'detail': 'Группа с таким именем уже существует'}, status=status.HTTP_400_BAD_REQUEST)
            except DatabaseError:
                return handle_database_error('Ошибка базы данных при создании группы')
    ...
    def retrieve(self, request, pk=None):
        ...
        if not group_data:
            try:
                ...
                cache.set(cache_key, group_data, timeout=300)  # Кэшируем на 5 минут
            except DatabaseError:
                return handle_database_error('Ошибка базы данных при получении группы')
    ...
    def partial_update(self, request, pk=None):
        ...
        if serializer.is_valid():
            try:
                ...
                return Response({'detail': 'Ошибка базы данных при обновлении группы'}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
    ...
    def update(self, request, pk=None):
        ...
        if serializer.is_valid():
            try:
                ...
                return handle_database_error('Ошибка базы данных при обновлении группы')
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
    ...
    def destroy(self, request, pk=None):
        ...
        try:
            ...
            return handle_database_error('Ошибка базы данных при удалении группы')
        ...
        for member_id in members_data:
            ...
            if membership:
                try:
                    ...
                    return handle_database_error('Ошибка базы данных при удалении участника')
            else:
    ...
    def add_members(self, request, pk=None):
        ...
        try:
            ...
            return Response({'detail': 'Ошибка добавления участника'}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def change_role(self, request, pk=None):
        ...
        try:
            ...
            return handle_database_error('Ошибка базы данных при изменении роли')
...
class InvitationViewSet(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        try:
            ...
            return Response({'detail': 'Ошибка при создании приглашения'}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def accept(self, request, pk=None):
        ...
        try:
            ...
            return handle_database_error('Ошибка базы данных при принятии приглашения')
    ...
    def decline(self, request, pk=None):
        ...
        try:
            ...
            return handle_database_error('Ошибка базы данных при отклонении приглашения')
